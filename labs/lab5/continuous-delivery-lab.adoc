...
. Login to your Jenkins instance at https://jenkins-0.example.com/ with the same username and password that you use for CloudFoundry.
...
export API=https://api.sys.gn01.pcf.dcsg.com
